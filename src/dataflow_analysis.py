...
def main():
    ...
    _build_dir = os.path.join(_script_dir, '..', 'build', 'test')
    input_file = sys.argv[1] if len(sys.argv) > 1 else os.path.join(_build_dir, 'test.txt')
    output_prefix = sys.argv[2] if len(sys.argv) > 2 else os.path.join(_build_dir, 'test_register_dfi')
