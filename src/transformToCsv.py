...
# ===================== 配置项 =====================
DISASM_FILE = "test.txt"  # 你的反汇编文件路径
OUTPUT_CSV = "test_jump_analysis.csv"  # 输出的CSV文件路径
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Transform objdump output to jump analysis CSV')
    parser.add_argument('--input', '-i', default=None,
                        help=f'Input objdump .txt file (default: {DISASM_FILE})')
    parser.add_argument('--output', '-o', default=None,
                        help=f'Output CSV file (default: {OUTPUT_CSV})')
    args = parser.parse_args()

    input_file = args.input or DISASM_FILE
