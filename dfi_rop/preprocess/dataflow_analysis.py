...
def main():
    ...
    default_input = os.path.join(build_dir, 'test.txt')
    default_prefix = os.path.join(build_dir, 'register_dfi')

    input_file = sys.argv[1] if len(sys.argv) > 1 else default_input
    output_prefix = sys.argv[2] if len(sys.argv) > 2 else default_prefix
